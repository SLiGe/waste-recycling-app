        ...
        wx.getSystemInfo({
            success: (res) => {
                ...
                if (rect && (res === null || res === void 0 ? void 0 : res.windowWidth)) {
                    boxStyleList.push(`--td-navbar-right:${(res.windowWidth - rect.left) * 2}rpx`);
                }
                boxStyleList.push(`--td-navbar-capsule-height: ${rect.height * 2}rpx`);
                boxStyleList.push(`--td-navbar-capsule-width: ${rect.width * 2}rpx`);
